                ...
                <div className="menu__box">
                    ...
                    <BurgerNav>
                        <div>
                            ...
                            <TeamsIconStyle>
                                <Link to='/Teams'>
                                    <StyledSvg  width="24" height="24" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                        <g id="group_person">
                                            <path id="group_person_2"
                        ...
                        <div style={{display: "grid"}}>
                            <Link to='/signIn'>
                                <img style={{paddingRight: "8px"}} src={SignOutIcon} alt="Sign out icon"/>
                                <StyledNav style={{ color: `${theme.lightestRed}`}}>Sign out</StyledNav>
                            </Link>
                        </div>
                    </BurgerNav>
                </div>
